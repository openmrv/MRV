...
Un visualiseur de séries chronologiques des exemples de dégradation se trouve dans le répertoire "OpenMRV" dans le fichier "OpenMRV_français/Part2/CODED_fr/Time Series Examples_fr" : 
